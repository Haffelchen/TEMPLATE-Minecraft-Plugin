...
import net.haffel.PL.args.uf.tmp.UfTmpClearSubArg;
import net.haffel.PL.args.uf.tmp.UfTmpListSubArg;
import net.haffel.PL.args.uf.tmp.UfTmpRemoveSubArg;
import net.haffel.PL.args.uf.tmp.UfTmpSaveSubArg;
 ...
 * @lastEdit v1.1
 */
public class UfTemporarySubArg extends ArgumentBase
{
	/**
	...
	{
		return TEMPLATE.getTranslatedString(sender, TranslationPaths.DESCRIPTION_ARG_UF_TMP.getPath());
	}
	...
	{
		loadPermission(PermissionNames.ARG_UF_TMP);
	}
	...
	{
		registerSubArgument(new UfTmpClearSubArg());
		registerSubArgument(new UfTmpListSubArg());
		registerSubArgument(new UfTmpRemoveSubArg());
		registerSubArgument(new UfTmpSaveSubArg());
	}
}
