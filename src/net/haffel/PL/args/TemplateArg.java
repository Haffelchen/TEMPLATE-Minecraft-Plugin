 ...
 */
public class TemplateArg extends ArgumentBase
{
	/**
	...
	{
		return TEMPLATE.getTranslatedString(sender, TranslationPaths.DESCRIPTION_ARG_TEMPLATE.getPath());
	}
	...
	{
		loadPermission(PermissionNames.ARG_TEMPLATE);
	}
}
